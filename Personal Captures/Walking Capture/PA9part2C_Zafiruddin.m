...
% 06/21/2021
% PA9part2C_Zafiruddin.m
%
% Takes video of gait motion, tracks the positions of the joints, and
% creates wireframe capture. (Part 2C: Ameen's Walk Video)

clear
clc
close all

delete walkVidCentroidAmeenC.avi
delete walkVidWireframeAmeenC.avi
...
% VIDEO INFORMATION
vidI = VideoReader('walkVidAmeen.mov'); % reads in .avi file
frameStart = 100; % starting frame for motion capture
frameStop = 188; % ending frame for motion capture
...
vidFA = VideoWriter('walkVidCentroidAmeenC.avi');
...
vidFB = VideoWriter('walkVidWireframeAmeenC.avi');
